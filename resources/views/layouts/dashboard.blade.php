  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
        <div class="sidebar-brand-text mx-3">Kelompok 4</div>
      </a>
      ...
      <li class="nav-item {{ (request()->is('master/*')) ? 'active' : '' }}">
        ...
        <div id="collapsePagesMaster" class="collapse nav-item {{ (request()->is('master/*')) ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item {{ (request()->is('master/universitas*')) ? 'active' : '' }}" href="{{ route('get.universitas') }}">Universitas</a>
            <a class="collapse-item {{ (request()->is('master/mahasiswa*')) ? 'active' : '' }}" href="{{ route('get.mahasiswa') }}">Mahasiswa</a>
          </div>
        </div>
      </li>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Silahkan pilih "Keluar" jika anda mau keluar</div>
